...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    LAYOUT_all(
        ...
        KC_CAPS,          RGB_HUD, RGB_HUI, RGB_SPD, RGB_SPI, RGB_TOG, KC_HOME, KC_PGDN, KC_PGUP, KC_END, KC_INS, KC_INS,          KC_MPLY,
        KC_LSFT,KC_LSFT,, RGB_VAD, RGB_VAI, RGB_VAD,  RGB_VAI, RESET,  EEP_RST, DEBUG, KC_HOME, KC_END, KC_INS, KC_RSFT, KC_VOLU,  KC_MUTE,
    ...
    LAYOUT_all(
        ...
        KC_CAPS,MEH(KC_A),MEH(KC_S),MEH(KC_D),MEH(KC_F),MEH(KC_G),MEH(KC_H),MEH(KC_J),MEH(KC_K),MEH(KC_L),MEH(KC_SCLN),MEH(KC_QUOT),MEH(KC_ENT),
    ...
    LAYOUT_all(
        ...
        KC_CAPS,HYPR(KC_A),HYPR(KC_S),HYPR(KC_D),HYPR(KC_F),HYPR(KC_G),HYPR(KC_H),HYPR(KC_J),HYPR(KC_K),HYPR(KC_L),HYPR(KC_SCLN),HYPR(KC_QUOT),HYPR(KC_ENT),
