...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    LAYOUT_all( //1
        ...
        RGB_TOG,      RGB_SAD,RGB_SAI,RGB_RMOD,RGB_MOD,KC_NO,KC_NO,KC_NO,KC_PSCR,KC_SLCK,KC_PAUS,LCTL(LGUI(KC_Q)),KC_NO,KC_BSLS,
        MO(3),         RGB_HUD,RGB_HUI,RGB_SPD,RGB_SPI,RGB_TOG,     KC_HOME,KC_PGDN,KC_PGUP,KC_END,HYPR(KC_LEFT),HYPR(KC_RGHT),KC_MPLY,
        KC_LSFT,KC_LSFT,RGB_VAD,RGB_VAI,RGB_VAD,RGB_VAI,KC_NO,KC_NO,KC_NO, KC_HOME,KC_END,HYPR(KC_DOWN),KC_RSFT,KC_VOLU,KC_MUTE,
    ...
    LAYOUT_all( //2
        ...
        KC_LSFT,KC_LSFT,MEH(KC_Z),MEH(KC_X),MEH(KC_C),MEH(KC_V),MEH(KC_B),MEH(KC_N),MEH(KC_M),MEH(KC_COMM),MEH(KC_DOT),MEH(KC_SLSH),       KC_RSFT,KC_UP,MEH(KC_DEL),
        KC_LCTL,KC_LALT,KC_LGUI,                                    KC_SPC,KC_SPC,KC_SPC,                              MO(2),MO(3),KC_LEFT,KC_DOWN,KC_RGHT
    ),
    ...
    LAYOUT_all( //3
        ...
        KC_LSFT,KC_LSFT,HYPR(KC_Z),HYPR(KC_X),HYPR(KC_C),HYPR(KC_V),HYPR(KC_B),HYPR(KC_N),HYPR(KC_M),HYPR(KC_COMM),HYPR(KC_DOT),HYPR(KC_SLSH),  KC_RSFT,KC_UP,HYPR(KC_DEL),
        KC_LCTL,KC_LALT,KC_LGUI,                                   KC_SPC,KC_SPC,KC_SPC,                                        MO(3),MO(3),KC_LEFT,KC_DOWN,KC_RGHT
    ),
    ...
    LAYOUT_all( //5
        KC_ESC,      KC_F1,KC_F2,KC_F3,KC_F4,KC_F5,KC_F6,KC_F7,KC_F8,KC_F9,KC_F10,KC_F11,KC_F12,KC_GRAVE,        KC_BSPC,
        RGB_TOG,      RGB_SAD,RGB_SAI,RGB_RMOD,RGB_MOD,KC_NO,KC_NO,KC_NO,KC_PSCR,KC_SLCK,KC_PAUS,LCTL(LGUI(KC_Q)),KC_NO,KC_BSLS,
        MO(7),         RGB_HUD,RGB_HUI,RGB_SPD,RGB_SPI,RGB_TOG,     KC_HOME,KC_PGDN,KC_PGUP,KC_END,HYPR(KC_LEFT),HYPR(KC_RGHT),KC_MPLY,
        KC_LSFT,KC_LSFT,RGB_VAD,RGB_VAI,RGB_VAD,RGB_VAI,KC_NO,KC_NO,KC_NO, KC_HOME,KC_END,HYPR(KC_DOWN),KC_RSFT,KC_VOLU,KC_MUTE,
    ...
    LAYOUT_all( //6
        ...
        KC_LSFT,KC_LSFT,MEH(KC_Z),MEH(KC_X),MEH(KC_C),MEH(KC_V),MEH(KC_B),MEH(KC_N),MEH(KC_M),MEH(KC_COMM),MEH(KC_DOT),MEH(KC_SLSH),       KC_RSFT,KC_UP,MEH(KC_DEL),
        KC_LCTL,KC_LALT,KC_LGUI,                                    KC_SPC,KC_SPC,KC_SPC,                              MO(6),MO(7),KC_LEFT,KC_DOWN,KC_RGHT
    ),
    ...
    LAYOUT_all( //7
        ...
        KC_LSFT,KC_LSFT,HYPR(KC_Z),HYPR(KC_X),HYPR(KC_C),HYPR(KC_V),HYPR(KC_B),HYPR(KC_N),HYPR(KC_M),HYPR(KC_COMM),HYPR(KC_DOT),HYPR(KC_SLSH),  KC_RSFT,KC_UP,HYPR(KC_DEL),
        KC_LCTL,KC_LALT,KC_LGUI,                                   KC_SPC,KC_SPC,KC_SPC,                                        MO(7),MO(7),KC_LEFT,KC_DOWN,KC_RGHT
    )
};