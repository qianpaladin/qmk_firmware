...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    LAYOUT_all( //1
        KC_ESC, KC_F1, KC_F2, KC_F3, KC_F4, KC_F5,   KC_F6,   KC_GRAVE, KC_F7,   KC_F8,   KC_F9,   KC_F10,  KC_F11,  KC_F12,    KC_BSPC,
        RGB_TOG,             RGB_SAD,RGB_SAI,RGB_RMOD , RGB_MOD, KC_NO, KC_NO, KC_NO, KC_NO,  KC_PSCR, KC_SLCK, KC_PAUS, KC_NO, KC_BSLS,
        MO(3),          RGB_HUD, RGB_HUI, RGB_SPD, RGB_SPI, RGB_TOG, KC_INS, KC_HOME, KC_PGDN, KC_PGUP, KC_END, KC_INS,           KC_MPLY,
        KC_LSFT,KC_LSFT, RGB_VAD, RGB_VAI, RGB_VAD,  RGB_VAI, KC_NO, RESET,  EEP_RST, DEBUG, KC_HOME, KC_END, KC_RSFT, KC_VOLU,  KC_MUTE,
