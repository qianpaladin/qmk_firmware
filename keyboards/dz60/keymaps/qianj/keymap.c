...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    LAYOUT_all( //0 qwerty 
        ...
        KC_LCTL,KC_LALT,KC_LGUI,        KC_SPC,MO(3),KC_SPC,       MO(4),MO(2),  KC_LEFT,KC_DOWN,KC_RIGHT
    ),

    LAYOUT_all( //1 Colemak
        KC_ESC,         KC_1,KC_2,KC_3,KC_4,KC_5,KC_GRAVE,KC_6,KC_7,KC_8,KC_9,KC_0,KC_MINS,KC_EQL,KC_BSPC,
    ...
    LAYOUT_all( //2 Functions
        ...
        XXXXXXX,XXXXXXX,XXXXXXX,                 XXXXXXX,XXXXXXX,XXXXXXX,               MO(5),MO(2),KC_MPRV,KC_VOLD,KC_MNXT
    ),

    LAYOUT_all( //3 Window Management 1
        ...
        XXXXXXX,XXXXXXX,XXXXXXX,                                    XXXXXXX,MO(3),XXXXXXX,                                  XXXXXXX,XXXXXXX,MEH(KC_LEFT),MEH(KC_DOWN),MEH(KC_RGHT)
    ),

    LAYOUT_all( //4 Window Management 2
        ...
        XXXXXXX,          MEH(KC_A),MEH(KC_S),MEH(KC_D),MEH(KC_F),MEH(KC_G),MEH(KC_SCLN),MEH(KC_H),MEH(KC_J),MEH(KC_K),MEH(KC_L),MEH(KC_QUOT),                      MEH(KC_ENT),
        XXXXXXX,XXXXXXX,MEH(KC_Z),MEH(KC_X),MEH(KC_C),MEH(KC_V),MEH(KC_SLSH),MEH(KC_B),MEH(KC_N),MEH(KC_M),MEH(KC_COMM),MEH(KC_DOT),           XXXXXXX,MEH(KC_UP),MEH(KC_DEL),
        XXXXXXX,XXXXXXX,XXXXXXX,                                    XXXXXXX,XXXXXXX,XXXXXXX,                                  MO(4),MO(5),MEH(KC_LEFT),MEH(KC_DOWN),MEH(KC_RGHT)
    ),
    
    LAYOUT_all( //5 Password and Power
        TG(1),          HYPR(KC_1),HYPR(KC_2),HYPR(KC_3),HYPR(KC_4),HYPR(KC_5),HYPR(KC_GRV),HYPR(KC_6),HYPR(KC_7),HYPR(KC_8),HYPR(KC_9),HYPR(KC_0),HYPR(KC_MINS),HYPR(KC_EQL),HYPR(KC_BSPC),
        ...
        XXXXXXX,XXXXXXX,XXXXXXX,                                    XXXXXXX,XXXXXXX,XXXXXXX,                                  MO(5),MO(5),         HYPR(KC_LEFT),HYPR(KC_DOWN),HYPR(KC_RGHT)
    )
