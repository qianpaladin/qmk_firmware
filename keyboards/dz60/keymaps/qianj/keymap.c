...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    LAYOUT_all( //0
        ...
        KC_TAB,         KC_Q,KC_W,KC_E,KC_R,KC_T,KC_LBRC,KC_Y,KC_U,KC_I,KC_O,KC_P,KC_SCLN,         KC_BSLS,
        MO(3),          KC_A,KC_S,KC_D,KC_F,KC_G,KC_RBRC,KC_H,KC_J,KC_K,KC_L,KC_QUOT,              KC_ENT,
    ...
    LAYOUT_all( //2
        ...
        KC_TAB,         MEH(KC_Q),MEH(KC_W),MEH(KC_E),MEH(KC_R),MEH(KC_T),MEH(KC_LBRC),MEH(KC_Y),MEH(KC_U),MEH(KC_I),MEH(KC_O),MEH(KC_P),           MEH(KC_SCLN),MEH(KC_BSLS),
        MO(3),          MEH(KC_A),MEH(KC_S),MEH(KC_D),MEH(KC_F),MEH(KC_G),MEH(KC_RBRC),MEH(KC_H),MEH(KC_J),MEH(KC_K),MEH(KC_L),MEH(KC_QUOT),                      MEH(KC_ENT),
    ...
    LAYOUT_all( //4
        KC_ESC,         KC_1,KC_2,KC_3,KC_4,KC_5,KC_GRAVE,KC_6,KC_7,KC_8,KC_9,KC_0,KC_MINS,KC_EQL,KC_BSPC,
        KC_TAB,         KC_Q,KC_W,KC_F,KC_P,KC_G,KC_LBRC,KC_J,KC_L,KC_U,KC_Y,KC_QUOT,KC_SCLN,         KC_BSLS,
    ...
    LAYOUT_all( //6
        KC_ESC,         MEH(KC_1),MEH(KC_2),MEH(KC_3),MEH(KC_4),MEH(KC_5),MEH(KC_GRV),MEH(KC_6),MEH(KC_7),MEH(KC_8),MEH(KC_9),MEH(KC_0),MEH(KC_MINS),MEH(KC_EQL),MEH(KC_BSPC),
        KC_TAB,         MEH(KC_Q),MEH(KC_W),MEH(KC_E),MEH(KC_R),MEH(KC_T),MEH(KC_LBRC),MEH(KC_Y),MEH(KC_U),MEH(KC_I),MEH(KC_O),MEH(KC_P),           MEH(KC_SCLN),MEH(KC_BSLS),
        MO(7),          MEH(KC_A),MEH(KC_S),MEH(KC_D),MEH(KC_F),MEH(KC_G),MEH(KC_RBRC),MEH(KC_H),MEH(KC_J),MEH(KC_K),MEH(KC_L),MEH(KC_QUOT),                      MEH(KC_ENT),
        KC_LSFT,KC_LSFT,MEH(KC_Z),MEH(KC_X),MEH(KC_C),MEH(KC_V),MEH(KC_B),MEH(KC_SLSH),MEH(KC_N),MEH(KC_M),MEH(KC_COMM),MEH(KC_DOT),           KC_RSFT,MEH(KC_UP),MEH(KC_DEL),
